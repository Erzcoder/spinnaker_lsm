...
dsg_targets[1, 0, 3] = \
    r"192.168.240.36_dataSpec_1_0_3.dat"
dsg_targets[0, 0, 9] = \
    r"192.168.240.36_dataSpec_0_0_9.dat"
dsg_targets[0, 0, 8] = \
    r"192.168.240.36_dataSpec_0_0_8.dat"
dsg_targets[1, 0, 1] = \
    r"192.168.240.36_dataSpec_1_0_1.dat"
dsg_targets[1, 0, 6] = \
    r"192.168.240.36_dataSpec_1_0_6.dat"
dsg_targets[1, 0, 7] = \
    r"192.168.240.36_dataSpec_1_0_7.dat"
dsg_targets[0, 0, 7] = \
    r"192.168.240.36_dataSpec_0_0_7.dat"
dsg_targets[1, 0, 4] = \
    r"192.168.240.36_dataSpec_1_0_4.dat"
dsg_targets[0, 0, 6] = \
    r"192.168.240.36_dataSpec_0_0_6.dat"
dsg_targets[1, 0, 5] = \
    r"192.168.240.36_dataSpec_1_0_5.dat"
dsg_targets[0, 0, 5] = \
...
dsg_targets[1, 0, 10] = \
    r"192.168.240.36_dataSpec_1_0_10.dat"
dsg_targets[0, 0, 16] = \
    r"192.168.240.36_dataSpec_0_0_16.dat"
dsg_targets[0, 0, 2] = \
    r"192.168.240.36_dataSpec_0_0_2.dat"
dsg_targets[1, 0, 11] = \
    r"192.168.240.36_dataSpec_1_0_11.dat"
dsg_targets[0, 0, 1] = \
    r"192.168.240.36_dataSpec_0_0_1.dat"
dsg_targets[1, 0, 8] = \
    r"192.168.240.36_dataSpec_1_0_8.dat"
dsg_targets[1, 0, 9] = \
    r"192.168.240.36_dataSpec_1_0_9.dat"
dsg_targets[0, 0, 15] = \
    r"192.168.240.36_dataSpec_0_0_15.dat"
dsg_targets[1, 0, 14] = \
    r"192.168.240.36_dataSpec_1_0_14.dat"
dsg_targets[0, 0, 14] = \
    r"192.168.240.36_dataSpec_0_0_14.dat"
dsg_targets[1, 0, 15] = \
    r"192.168.240.36_dataSpec_1_0_15.dat"
dsg_targets[0, 0, 13] = \
    r"192.168.240.36_dataSpec_0_0_13.dat"
dsg_targets[1, 0, 12] = \
    r"192.168.240.36_dataSpec_1_0_12.dat"
dsg_targets[0, 0, 12] = \
    r"192.168.240.36_dataSpec_0_0_12.dat"
dsg_targets[1, 0, 13] = \
    r"192.168.240.36_dataSpec_1_0_13.dat"
dsg_targets[0, 0, 11] = \
    r"192.168.240.36_dataSpec_0_0_11.dat"
dsg_targets[1, 0, 2] = \
    r"192.168.240.36_dataSpec_1_0_2.dat"
dsg_targets[0, 0, 10] = \
    r"192.168.240.36_dataSpec_0_0_10.dat"
executable_targets.add_processor(
    r"spike_source_poisson.aplx", 1, 0, 15)
executable_targets.add_processor(
    r"IZK_cond_exp.aplx", 1, 0, 1)
executable_targets.add_processor(
    r"IZK_cond_exp.aplx", 1, 0, 2)
executable_targets.add_processor(
    r"IZK_cond_exp.aplx", 1, 0, 3)
executable_targets.add_processor(
    r"IZK_cond_exp.aplx", 1, 0, 4)
executable_targets.add_processor(
    r"IZK_cond_exp.aplx", 1, 0, 5)
executable_targets.add_processor(
    r"IZK_cond_exp.aplx", 1, 0, 6)
executable_targets.add_processor(
    r"IZK_cond_exp.aplx", 1, 0, 7)
executable_targets.add_processor(
    r"IZK_cond_exp.aplx", 1, 0, 8)
executable_targets.add_processor(
    r"IZK_cond_exp.aplx", 1, 0, 9)
executable_targets.add_processor(
    r"IZK_cond_exp.aplx", 1, 0, 10)
executable_targets.add_processor(
    r"IZK_cond_exp.aplx", 1, 0, 11)
executable_targets.add_processor(
    r"IZK_cond_exp.aplx", 1, 0, 12)
executable_targets.add_processor(
    r"IZK_cond_exp.aplx", 1, 0, 13)
executable_targets.add_processor(
    r"IZK_cond_exp.aplx", 1, 0, 14)
executable_targets.add_processor(
    r"IZK_cond_exp.aplx", 0, 0, 1)
executable_targets.add_processor(
    r"IZK_cond_exp.aplx", 0, 0, 2)
executable_targets.add_processor(
    r"IZK_cond_exp.aplx", 0, 0, 3)
executable_targets.add_processor(
    r"IZK_cond_exp.aplx", 0, 0, 4)
executable_targets.add_processor(
    r"IZK_cond_exp.aplx", 0, 0, 5)
executable_targets.add_processor(
    r"IZK_cond_exp.aplx", 0, 0, 6)
executable_targets.add_processor(
    r"IZK_cond_exp.aplx", 0, 0, 7)
executable_targets.add_processor(
    r"IZK_cond_exp.aplx", 0, 0, 8)
executable_targets.add_processor(
    r"IZK_cond_exp.aplx", 0, 0, 9)
executable_targets.add_processor(
    r"IZK_cond_exp.aplx", 0, 0, 10)
executable_targets.add_processor(
    r"IZK_cond_exp.aplx", 0, 0, 11)
executable_targets.add_processor(
    r"IZK_cond_exp.aplx", 0, 0, 12)
executable_targets.add_processor(
    r"IZK_cond_exp.aplx", 0, 0, 13)
executable_targets.add_processor(
    r"IZK_cond_exp.aplx", 0, 0, 14)
executable_targets.add_processor(
    r"IZK_cond_exp.aplx", 0, 0, 15)
executable_targets.add_processor(
    r"IZK_cond_exp.aplx", 0, 0, 16)
